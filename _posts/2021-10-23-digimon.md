...
data = list(csv.DictReader(f))
    speeds = []  # creates a new empty ;ist of all the values
    digimonTeam = []  # creates a new empty list called digimonTeam
    # this for loop lets us iterate through every single digimon in the csv
    for digimon in data:
